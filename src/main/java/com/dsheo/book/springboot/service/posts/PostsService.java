package com.dsheo.book.springboot.service.posts;

import com.dsheo.book.springboot.domain.posts.Posts;
import com.dsheo.book.springboot.domain.posts.PostsRepository;
import com.dsheo.book.springboot.web.dto.PostsListResponseDto;
...
public class PostsService {
    ...
    public void delete(Long id) {
        Posts posts = postsRepository.findById(id).orElseThrow(()
                -> new IllegalArgumentException("해당 게시물이 없오요 id=" + id));
